...
| `v0.2.0.4-behavior-freeze`（本版） | positionBook 生命周期（full close 重置 peak）、OriginKnown 左审查（首段 observed episode 不可信，直到确认 full close）、ClassifiedEntry 拆 TokenAmount/AmountUSD、RebuildEpisodes 明确 legacy/debug 缓存 |
