...
| `v0.1.4-actor-replication`（本版） | Actor 级 coverage-aware replication census（survivor-bias guard）、`actors rank --sort/--frontier`、空 kline 不再直接判死（no_kline_data + backoff）、price_parse_error retry 闭环 |
