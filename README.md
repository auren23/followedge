...
版本：`v0.1.3.3-measurement-freeze`。
...
| `v0.1.3.3-measurement-freeze`（本版） | terminal status 不再每 tick 重采、fixed horizon 按 candle close time（lag∈[0,res]）、coverage 拆 unresolved_due/not_due、migration 事务原子化 |
